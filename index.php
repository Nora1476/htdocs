...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed">
				...
				<div class="c-navbar-wrapper clearfix">
					...
					<nav class="c-mega-menu c-mega-menu-onepage c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold" data-onepage-animation-speed="700">
						<ul class="nav navbar-nav c-theme-nav">
							...
							<li class="c-onepage-link ">
								<a href="#clients" class="c-link">Clients</a>
							</li>
						</ul>
					</nav>
					<!-- END: MEGA MENU -->
				...
				<div class="tp-banner rev_slider" data-version="5.0">
					<ul>
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
							<img alt="" src="./img_main/main1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
							...
							<div class="tp-caption lft" data-x="center" data-y="center" data-voffset="110" data-speed="900" data-start="2000" data-transform_idle="o:1;" data-transform_in="x:100;y:100;rX:120;scaleX:0.75;scaleY:0.75;o:0;s:500;e:Back.easeInOut;" data-transform_out="x:100;y:100;rX:120;scaleX:0.75;scaleY:0.75;o:0;s:500;e:Back.easeInOut;">
								<a href="portfolio.php" class="c-action-btn btn btn-lg c-theme-btn c-btn-bold c-btn-uppercase"> 더보기 </a>
							</div>
						</li>
						<!--END -->
						<!--BEGIN: SLIDE #2 -->
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
							<img alt="" src="./img_main/main2.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="700" data-delay="6000" data-thumb="">
							...
							<img alt="" src="./img_main/main3.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="visible-xs" />
							<div class="rs-background-video-layer" data-forcerewind="on" data-volume="mute" data-videowidth="100%" data-videoheight="100%" data-videomp4="./assets/base/media/video/video-2.mp4" data-videopreload="preload" data-videoloop="none" data-forceCover="1" data-aspectratio="16:9" data-autoplay="true" data-autoplayonlyfirsttime="false" data-nextslideatend="true"></div>
							...
							<div class="tp-caption lft" data-x="center" data-y="center" data-voffset="130" data-speed="900" data-start="2000" data-transform_idle="o:1;" data-transform_in="x:100;y:100;rX:120;scaleX:0.75;scaleY:0.75;o:0;s:900;e:Back.easeInOut;" data-transform_out="x:100;y:100;rX:120;scaleX:0.75;scaleY:0.75;o:0;s:900;e:Back.easeInOut;">
								<a href="portfolio.php" class="c-action-btn btn btn-lg c-btn-border-2x c-btn-white c-btn-bold c-btn-uppercase"> 더보기 </a>
							</div>
						</li>
						<!--END -->
					</ul>
					...
					<div class="cbp-panel">
						...
						<div class="c-content-latest-works cbp cbp-l-grid-masonry-projects wow animate fadeInLeft">
							<div class="cbp-item graphic">
								<div class="cbp-caption">
									<div class="cbp-caption-defaultWrap">
										<img src="./img_main/우암동아파트.png" alt="">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="c-masonry-border"></div>
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
												<a href="./img_main/우암동아파트.png" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="우암동 아파트">zoom</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="cbp-item web-design logos wow animate fadeInLeft">
								<div class="cbp-caption">
									<div class="cbp-caption-defaultWrap">
										<img src="./img_main/동백맨션.png" alt="">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="c-masonry-border"></div>
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
												<a href="./img_main/동백맨션.png" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="동백맨션">zoom</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="cbp-item graphic logos wow animate fadeInLeft" data-wow-delay="0.2s">
								<div class="cbp-caption">
									<div class="cbp-caption-defaultWrap">
										<img src="./img_main/만덕미용실.png" alt="">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="c-masonry-border"></div>
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
												<a href="./img_main/만덕미용실.png" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="만덕 미용실">zoom</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="cbp-item identity web-design wow animate fadeInLeft" data-wow-delay="0.4s">
								<div class="cbp-caption">
									<div class="cbp-caption-defaultWrap">
										<img src="./img_main/부림아파트.png" alt="">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="c-masonry-border"></div>
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
												<a href="./img_main/부림아파트.png" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="부림아파트">zoom</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="cbp-item web-design graphic wow animate fadeInLeft">
								<div class="cbp-caption">
									<div class="cbp-caption-defaultWrap">
										<img src="./img_main/진해만화카페.png" alt="">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="c-masonry-border"></div>
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
												<a href="./img_main/진해만화카페.png" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="진해 만화카페">zoom</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="cbp-item identity web-design wow animate fadeInLeft" data-wow-delay="0.2s">
								<div class="cbp-caption">
									<div class="cbp-caption-defaultWrap">
										<img src="./img_main/참치사랑.png" alt="">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="c-masonry-border"></div>
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
												<a href="./img_main/참치사랑.png" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="참치사랑애">zoom</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="cbp-item graphic logos wow animate fadeInLeft" data-wow-delay="0.4s">
								<div class="cbp-caption">
									<div class="cbp-caption-defaultWrap">
										<img src="./img_main/헬스장.png" alt="">
									</div>
									<div class="cbp-caption-activeWrap">
										<div class="c-masonry-border"></div>
										<div class="cbp-l-caption-alignCenter">
											<div class="cbp-l-caption-body">
												<a href="./img_main/헬스장.png" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="헬스장">zoom</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="c-content-panel">
									<div class="c-body">
										<form id="contactFrm" class="form-horizontal">
											<div class="form-group">
												<label for="name" class="col-md-4 control-label"> 성명 * </label>
												<div class="col-md-6">
													<input type="text" class="form-control  c-square c-theme" id="name" name="name">
												</div>
											</div>
											<div class="form-group">
												<label for="phone" class="col-md-4 control-label"> 연락처 * </label>
												<div class="col-md-6">
													<input type="text" class="form-control  c-square c-theme" id="phone" name="phone">
												</div>
											</div>
											<div class="form-group">
												<label for="location" class="col-md-4 control-label"> 현장위치 * </label>
												<div class="col-md-6">
													<input type="text" class="form-control  c-square c-theme" id="location" name="location">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 control-label">임대차계약 *</label>
												<div class="col-md-6">
													<label class="radio-inline">
														<input type="radio" name="lease_agreement" id="lease_agreement" value="유"> 유
													</label>
													<label class="radio-inline">
														<input type="radio" name="lease_agreement" id="lease_agreement" value="무"> 무
													</label>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-6">
													<label class="radio-inline">
														<input type="radio" name="type" id="type" value="자가"> 자가
													</label>
													<label class="radio-inline">
														<input type="radio" name="type" id="type" value="전세"> 전세
													</label>
													<label class="radio-inline">
														<input type="radio" name="type" id="type" value="임대"> 임대
													</label>
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-md-4 control-label">기타
													<br>
													<span style="font-size:12px;">(특이사항, 희망사항, 질문사항)</span>
												</label>
												<div class="col-md-6">
													<textarea class="form-control  c-square c-theme" rows="10" id="content" name="content"></textarea>
												</div>
											</div>
											<div class="form-group c-margin-t-40">
												<div class="col-sm-offset-4 col-md-8">
													<input type="submit" class="btn c-theme-btn c-btn-square c-btn-uppercase c-btn-bold" id="contactBtn" value="submit">
													<button class="btn btn-default c-btn-square c-btn-uppercase c-btn-bold">Cancel</button>
												</div>
											</div>
										</form>
									</div>
	...
	<!-- END: PAGE CONTAINER -->
	<!-- /.modal-content -->
	<div id="checkModal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-sm">
			<div class="modal-content c-square">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="mySmallModalLabel">등록 확인</h4>
				</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#contactFrm").submit(function(e) {
				...
				if ($(':radio[name="lease_agreement"]:checked').length <
					1) {
					alert("임대차계약 여부를 선택해주세요.");
					return false;
				}
				...
				$.ajax({
					...
					success: function(data) {
						$('#checkModal').modal('show'); //등록 성공 모달창
						$('form').each(function() { //form 리셋
							this.reset();
						});
					},
				});
