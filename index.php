...
<head>
	<meta charset="utf-8"/>
	<title>JANGO | Ultimate Multipurpose Bootstrap HTML Theme - Onepage Version 7</title>
...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen"> 
				...
				<div class="c-navbar-wrapper clearfix">
					...
					<nav class="c-mega-menu c-mega-menu-onepage c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold" data-onepage-animation-speed="700">
						<ul class="nav navbar-nav c-theme-nav"> 
							...
							<li class="c-onepage-link ">
								<a href="#table" class="c-link">Table</a>
							</li>
							<li class="c-onepage-link ">
	...
	<div class="c-layout-page">
				...
				<div class="tp-banner rev_slider" data-version="5.0">
					<ul>
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000">			
							<img 
								alt="" 
								src="./assets/base/img/content/backgrounds/bg-45.jpg"
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000">			
							<img 
								alt="" 
								src="./assets/base/img/content/backgrounds/bg-60.jpg"
								data-bgposition="center center" 
								data-bgfit="cover" 
								data-bgrepeat="no-repeat"
							>	
		...
		<section id="table">
				...
				<div class="container">
					<div class="c-content-counter-1">
						<div class="c-content-title-2">
							<h3 class="c-center c-font-uppercase c-font-black c-font-bold">Table</h3>
							<div class="c-line c-dot c-dot-center c-theme-bg c-theme-bg-after c-line-short"></div>
						</div>	
						
						<table id="example" class="display" style="width:100%">
							<button type="button" id="btn_employee" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#add_Em">Add Employee</button>
			        <thead>
		            <tr>
		            	<th></th>
		            	<th>Id</th>
	                ...
	                <th>Button</th>
						...
						<!-- table Add Employee Modal -->
						<div class="modal fade" id="add_Em" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">				      	
							        ...
							        <input name="position" id="position" value=""/>  <br>
							        
							        <label> Office :: </label>
							        <input name="office" id="office" value=""/>  <br>
							        
							        <label> Extn :: </label>
							        <input name="extn" id="extn" value=""/>  <br>
							        
							        <label> Salary :: </label>
							        <input name="salary" id="salary" value=""/>  <br>
							        
							        <div class="modal-footer">
								        <button type="button" id="btn_newemployee" class="btn c-theme-btn c-btn-uppercase btn-lg c-btn-bold c-btn-square">Register</button>
							        	<button type="button" id="close_modal" class="btn c-theme-btn c-btn-uppercase btn-lg c-btn-bold c-btn-square" data-bs-dismiss="modal" >Close</button>
						    		  </div>						        
						      </div>
						    </div>
						  </div>
						...
						<!-- table Modify Employee Modal -->
						<div class="modal fade" id="check_modi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <div class="modal-footer">
							        <button type="button" id="btn_okmodi" class="btn btn-secondary c-btn-uppercase btn-lg c-btn-bold">Modify</button>
						        	<button type="button" id="btn_nomodi" class="btn c-theme-btn c-btn-uppercase btn-lg c-btn-bold">Cancel</button>
					    		  </div>						        
						      </div>
						    </div>
						  </div>
			...
			</div><!-- END: CONTENT/STATS/COUNTER-2 -->
		</section>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="c-container c-left">
						<div class="c-content-title-1">
							<h3 class="c-font-uppercase c-font-bold">Info Hub</h3>
							<div class="c-line-left"></div>
						</div>
						<div class="c-links">
							<ul class="c-nav">
  ...
  <!-- BEGIN: CORE PLUGINS -->
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDw3KoVMUwZom-lMgkHnZTMS7yjBxVrCCk"&callback=myMap" type="text/javascript"></script>
