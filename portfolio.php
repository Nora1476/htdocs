            ...
            <div data-filter=".commerce" class="cbp-filter-item">
               상업 <div class="cbp-filter-counter"></div>
					...
					<div id="grid-container" class="cbp">				
						...
						<? 
							while($row = mysqli_fetch_array($result)){	
								...
								echo "					<a href='./" .$row['file']. "' class='cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase'  data-title='World Clock Widget<br>by Paul Flavius Nechita'>Zoom</a>";
								echo "				</div>";
								echo "			</div>";
								echo "		</div>";
								echo "	</div>";
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<button href="ajax/projects/project2.html"
                      class=" btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase" id="pf_detail">Explore</button>
											<a href="./assets/base/img/content/stock/61.jpg"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="World Clock Widget<br>by Paul Flavius Nechita">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item home">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project3.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="http://vimeo.com/14912890"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="To-Do Dashboard<br>by Tiberiu Neamu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item home">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project4.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
                      ...
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="Events and  More<br>by Tiberiu Neamu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item home">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project5.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="./assets/base/img/content/stock/64.jpg"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="WhereTO App<br>by Tiberiu Neamu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item home">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project6.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="./assets/base/img/content/stock/65.jpg"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="Ski * Buddy<br>by Tiberiu Neamu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item other">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project7.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="./assets/base/img/content/stock/66.jpg"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="Seemple* Music for iPad<br>by Tiberiu Neamu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item other">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project8.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="http://www.youtube.com/watch?v=Bu9OiDmxCrQ"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="Remind~Me More<br>by Tiberiu Neamu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item other">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project9.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="https://www.ted.com/talks/andrew_bastawrous_get_your_next_eye_exam_on_a_smartphone"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
						...
						<div class="cbp-item other">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project10.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="https://www.youtube.com/watch?v=3wbvpOIIBQA"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="Bills Bills Bills<br>by Cosmin Capitanu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item other">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project11.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
											<a href="./assets/base/img/content/stock/70.jpg"
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="Generic Apps<br>by Cosmin Capitanu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="cbp-item other">
							<div class="cbp-caption">
								...
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="ajax/projects/project12.html"
                      class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase">Explore</a>
                      ...
                      class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"
                      data-title="Speed Detector<br>by Cosmin Capitanu">Zoom</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div id="loadMore-container" class="cbp-l-loadMore-button c-margin-t-60">
						<a href="ajax/4col-portfolio/load-more.html"
            class="cbp-l-loadMore-link btn btn-sm c-btn-square c-btn-border-2x c-btn-dark  c-btn-uppercase">
